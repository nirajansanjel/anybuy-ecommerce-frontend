  ...
  return (
    <div className={showFilter ? "block absolute" : "hidden"}>
      ...
      <div className="overflow-y-auto fixed top-14 left-0 z-20 h-screen bg-white px-4 pt-8 pb-14 min-w-64 shadow-md dark:bg-slate-800">
        <div className="text-xl font-medium p-2 pt-6 dark:text-white">
          Filter Products
        </div>
        <div className="py-3">
          <label
        ...
        <div>
          ...
          <button
            type="button"
            className="text-white bg-red-700 hover:bg-red-800  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            onClick={resetFilter}
          >
            Reset filters
          </button>
